...
const Violations = ({ getViolations, violations }) => {
  ...
  return (
    <div className="container" style={{ marginBottom: "100px" }}>
      <h1>
        <span></span>
        <span className="grey-text">Monthly</span>{" "}
        <span className="purple-text">Violations</span>
      </h1>
      <h5 className="grey-text">
        Enter the following details to visualize the monthly violations
      </h5>
      <div className="form">
        <div className="row">
          <div className="col s12">
            ...
            <div className="input-field inline">
              <i class="material-icons prefix purple-text small">
                calender_today
              </i>
        ...
        <div
          className="btn btn-large waves-effect waves-light purple darken-2"
          onClick={onSubmit}
        >
          Create my chart
        </div>
      ...
      <div>
        {violations && (
          <div>
            ...
            <h5>
              <span></span>
              <span className="grey-text">Social Distancing</span>{" "}
              <span className="purple-text">Violations---></span>
            </h5>
            <h6>
              Total no of Social Distancing violations over this month-
              <span className="purple-text">
                <b>{violations.Social_Distancing_Violation_Month}</b>
              </span>
            </h6>
            <br />
            <br />
            ...
            <h5>
              <span></span>
              <span className="grey-text">Mask </span>
              <span className="purple-text">Violations---></span>
            </h5>
            <h6>
              Total no of Mask violations over this month-
              <span className="purple-text">
                <b>{violations.Mask_Violation_Month}</b>
              </span>
            </h6>

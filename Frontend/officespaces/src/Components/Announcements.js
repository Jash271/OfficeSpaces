...
import { filterAnnouncement, clearFilterAnnouncement } from '../actions/announcementActions'

const Announcements = ({ totalAnn, getAnnouncements, filterAnnouncement, clearFilterAnnouncement, filtered }) => {
    ...
    useEffect(() => {
        const word = 'Token ';
        const token = word.concat(`23d59ee86227db5d94974ee692fe5b29c050c81c`);
    ...
    return (
        <div>
            <div className="center">
                <h1><span className="grey-text">Our</span> <span className="purple-text">Announcements</span> </h1>
            </div>
            ...
            <div className="row">
                {totalAnn && (filtered ?
                    <Card data={filtered} /> : <Card data={totalAnn} />
                )
...
export default connect(mapStateToProps, { getAnnouncements, filterAnnouncement, clearFilterAnnouncement })(Announcements)
